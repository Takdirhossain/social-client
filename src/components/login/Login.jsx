...
const navigate = useNavigate()
  ...
  const handalesubmit = e => {
    ...
    fetch("https://ecommerce-server-six.vercel.app/api/auth/login", {
      method: "POST",
      headers: {
                ...
                <div class="w-full  px-4">
                  <div class="shadow-lg relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]">
                    ...
                    <ul class="-mx-2 mb-12 flex justify-between">
                      ...
                      <li class="w-full px-2">
                        <Link onClick={handaleLogin} class="flex h-11 items-center justify-center rounded-md bg-[#D64937] hover:bg-opacity-90">
                          <svg
                            width="18"
                            height="18"
                            viewBox="0 0 18 18"
